import heroMain from "./hero/image-hero-1.webp";
import logoIcon from "./logo/dermaraiz-icon.svg";

import productAntiCaida from "./products/shampoo-anticaida-dermaraiz.webp";
...
import treatmentImplantProcedure from "./treatments/procedimiento-implante-capilar-fue-dermaraiz.jpeg";
import treatmentPrpApplication from "./treatments/prp-capilar-aplicacion-dermaraiz.jpeg";
import treatmentPrpPlasma from "./treatments/prp-capilar-plasma-rico-en-plaquetas-dermaraiz.jpg";
import treatmentZafiroTechnique from "./treatments/tecnica-zafiro-dermaraiz.webp";
...
export const productImages = {
    antiCaida: productAntiCaida,
    antiCaspa: productAntiCaspa,
    neutro: productNeutro,
};
...
export const treatmentImages = {
    ...
    implantProcedure: treatmentImplantProcedure,
    prpApplication: treatmentPrpApplication,
    prpPlasma: treatmentPrpPlasma,
    zafiroTechnique: treatmentZafiroTechnique,
};
