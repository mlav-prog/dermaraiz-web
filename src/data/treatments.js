...
export const aestheticTreatments = [
    {
        title: "Plasma rico en plaquetas",
        description:
            "Tratamiento regenerativo que acompaña la calidad de la piel y estimula procesos naturales de reparación.",
    },
    {
        title: "Mesoterapia facial y corporal",
        description:
            "Aplicación localizada de activos para mejorar hidratación, firmeza y aspecto general de la piel.",
    },
    {
        title: "NCTF / PDRN",
        description:
    ...
    },
    {
        ...
        description:
            "Abordaje médico para suavizar arrugas dinámicas y tratar casos seleccionados de sudoración o bruxismo.",
    },
    {
        title: "Peeling médico",
        description:
            "Renovación controlada de la piel para mejorar manchas, textura, poros y signos superficiales de envejecimiento.",
    },
    {
        title: "Skinbooster",
        description:
            "Hidratación profunda con ácido hialurónico para aportar frescura, elasticidad y mejor calidad cutánea.",
    },
];
